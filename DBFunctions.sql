CREATE FUNCTION OR ALTER Food.GetRestaurantRating (@RestID INT)
RETURNS FLOAT
AS
BEGIN
...
CREATE FUNCTION OR ALTER Food.GetLatestStatus (@OrdID INT)
RETURNS VARCHAR(50)
AS
BEGIN
...
CREATE FUNCTION OR ALTER  Food.GetFinalPrice (@OrdID INT)
